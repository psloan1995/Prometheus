...
import java.util.Random;
	public class battle_System {
		method_Orc Orc = new method_Orc(); // Bringing in all of the Orc's information. 
		enemy_Class enemyQuotes = new enemy_Class();
		method_Warrior Warrior = new method_Warrior(); // Bringing in all of the Warriors information. 
		Enemy_Stats Enemy = new Enemy_Stats();
